      ...
      <div className="container">
        <div className="row">
          <div className="col-md-8 pb-5">
            <img className="img-fluid my-3" src={food.image} alt="" />
            ...
            <div className="my-2">
              <span>3000 sq-ft.,</span> <span>{food.location}</span>{" "}
              <span>{food.bedroom} Bedroom</span>{" "}
              <span>{food.bathroom} Bathroom</span>
            </div>
            ...
            <div className="property">
              ...
              <p>
                <small>
                  Address & Area : Rangs Malancha, food-68, Road-6A (Dead End
